...
(1, 'Sandi Maulidika', 'sandimaulidika@gmail.com', 'SanSan.jpg', '$2y$10$QNZyEGDDDa9CjIvG08Ny0OrSibp.RrF5ZjFLvu99oCeGu.04QXq7u', 1, 1, 1661189930);
...
(17, 5, 'Setting', '#', 'settings-gear-65 text-primary', 1),
(18, 6, 'Blog', '#', 'palette text-danger', 1),
(19, 6, 'Portfolio', '#', 'palette text-danger', 1),
(20, 6, 'About', '#', 'palette text-danger', 1),
