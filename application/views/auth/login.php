                        ...
                        <div class="card card-plain">
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="text-sm mx-auto">
                                    Belum punya akun?
                                    <a href="<?php echo site_url('auth/registration') ?>" class="text-primary text-gradient font-weight-bold">Registration</a>
                                </p>
                                <p class="text-sm mx-auto">
                                    <a href="<?php echo site_url('auth/') ?>" class="text-primary text-gradient font-weight-bold">Forgot Password?</a>
                                </p>
                            </div>
                        </div>
                    </div>
