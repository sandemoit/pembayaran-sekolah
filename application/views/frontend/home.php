<section class="banner-two">
    ...
    <div class="container">
        <img src="<?= base_url('assets/frontend') ?>/images/mocups/banner-moc-3-1.png" class="banner-two__moc" alt="">
        <div class="row">
            <div class="col-lg-6">
...
<section class="service-one service-one__home-three">
    <img src="<?= base_url('assets/frontend') ?>/images/shapes/service-1-h3-shape-1.png" class="service-one__home-three__bg-1" alt="">
    <img src="<?= base_url('assets/frontend') ?>/images/shapes/service-1-h3-shape-2.png" class="service-one__home-three__bg-2" alt="">
    <img src="<?= base_url('assets/frontend') ?>/images/shapes/service-1-h3-shape-3.png" class="service-one__home-three__bg-3" alt="">
    <div class="container">
        <div class="block-title text-center">
    ...
    <div class="container">
        ...
        <div class="thm__owl-carousel blog-one__carousel owl-carousel owl-theme" data-carousel-prev-btn=".blog-one__carousel-btn-left" data-carousel-next-btn=".blog-one__carousel-btn-right" data-options='{
            ...
            <div class="item">
                <div class="blog-one__single">
                    <div class="blog-one__image">
                        <img src="<?= base_url('assets/frontend') ?>/images/blog/blog-1-2.jpg" alt="">
                        <a href="blog-details.html"><i class="fal fa-plus"></i></a>
                    </div><!-- /.blog-one__image -->
                    <div class="blog-one__content">
                        <div class="blog-one__meta">
            ...
            <div class="item">
                <div class="blog-one__single">
                    <div class="blog-one__image">
                        <img src="<?= base_url('assets/frontend') ?>/images/blog/blog-1-3.jpg" alt="">
                        <a href="blog-details.html"><i class="fal fa-plus"></i></a>
                    </div><!-- /.blog-one__image -->
                    <div class="blog-one__content">
                        <div class="blog-one__meta">
